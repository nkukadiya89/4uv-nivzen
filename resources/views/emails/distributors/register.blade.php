...
<body>
<div class="container">
    <div class="header">Hello {{ $distributor['firstname'] }} {{ $distributor['lastname'] }}!</div>
    <div class="content">
        Congratulations! Your account has been created successfully. You can login now and start using our service.
        <br><br>
        <strong>Email:</strong> <a href="mailto:{{ $distributor['email'] }}" class="highlight">{{ $distributor['email'] }}</a><br>
