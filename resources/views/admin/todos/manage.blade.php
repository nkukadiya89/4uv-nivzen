                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('todo-add-form') }}" class="btn btn-warning font-weight-bolder">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
                            ...
                            <tr class="filter">
                                ...
                                <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="date"></td>
                                <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="time"></td>
                                <td></td>
                                <td></td>
                                <td>
