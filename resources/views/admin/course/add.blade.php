            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <!--begin::Form-->
                        <form class="form-horizontal" id="frmAdd"  action="{{ route('course-add') }}" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label  class="col-lg-3 col-form-label" for="course_id">Course Id<span class="required">*</span></label>
                                    <div class="col-lg-6">
                                        <input id="course_id" type="text" class="form-control required" name="course_id" value="{{ old('course_id') }}" placeholder="Course Id" >
                                    </div>
                                </div>
                                <div class="form-group row">
