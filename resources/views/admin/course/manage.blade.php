                ...
                <div class="card-header">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('course-add-form') }}" class="btn btn-warning font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
                        ...
                        <thead>
                            <tr class="filter">
                                <td></td>
                                <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="course_id"></td>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
        ...
        var url =  '{{config('constants.ADMIN_URL')}}courses/list-ajax';
