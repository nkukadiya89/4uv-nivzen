                ...
                <div class="card-header">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('batche-add-form') }}" class="btn btn-warning font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
                        ...
                        <thead>
                            <tr class="filter">
                                <td></td>
                                <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="batch_id"></td>
                                <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="title"></td>
                                <td width="20%"> 
                                    
                                    <input type="text" id="date_range_1" name="date_range_1" class="form-control form-control-sm form-filter kt-input" placeholder="Select date">
                                </td>

                                <td width="20%"> 
                                    <input type="text" id="date_range_2" name="date_range_2" class="form-control form-control-sm form-filter kt-input" placeholder="Select date">
                               </td>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
        ...
        $('#date_range_2').on('cancel.daterangepicker', function(ev, picker) {
            $(this).val('');
        });
