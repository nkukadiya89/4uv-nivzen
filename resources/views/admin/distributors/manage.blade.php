        ...
        <div class="p-6">
            ...
            <div class="card card-custom w-full">
                <div class="card-header align-content-center">
                    ...
                    <div class="p-2">
                        @if(auth()->user()->hasRole('Administrator') || auth()->user()->can('distributor add'))
                ...
                <div class="card-body">
                    ...
                    <div class="table-bulk-action kt-hide">
                        ...
                        <input type="hidden" class="table-group-action-url"
                               value="<?php echo 'distributors/bulk-action';?>" />
                    </div>
...
@section('custom_js')
    <script>
        $(document).ready(function() {
            ...
            var url = '{{config('constants.ADMIN_URL ')}}distributors/list-ajax';
