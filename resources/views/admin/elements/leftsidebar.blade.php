...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu mb-0" data-menu-vertical="1" data-menu-scroll="1"
        data-menu-dropdown-timeout="500">
        <!--begin::Menu Nav-->
        <?php $current_url = substr(url()->current(),strpos(url()->current(),"backend/")+8);?>
        <ul class="menu-nav">
            <li class="menu-item menu-item-submenu {{ $current_url=='dashboard' ? 'menu-item-active' : '' }}"
...
{{--            @endrole--}}
            ...
            @role(['Administrator', 'GoldenAdmin', 'SuperAdmin', 'DistAdmin', 'Distributor'])
            <li class="menu-item {{ str_contains($current_url, 'machine-users') ? 'menu-item-active' : '' }} "
                aria-haspopup="true">
                <a href="{{url('backend/machine-users')}}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="menu-text">Machine Users</span>
                </a>
            </li>
            @endrole
