                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span class="navi-text text-muted text-hover-primary">{{auth()->guard('backend')->user()->email}}</span>
                            </span>
                        </a>
                        <a href="#" class="btn btn-sm btn-light-warning font-weight-bolder py-2 px-5"  onclick="event.preventDefault(); document.getElementById('logout-form-admin').submit();">Sign Out</a>


                     <form id="logout-form-admin" action="{{route('backend-logout')}}" method="POST" style="display: none;">
