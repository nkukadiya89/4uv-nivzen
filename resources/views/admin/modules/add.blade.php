            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <!--begin::Form-->
                        <form class="form-horizontal" id="frmAdd"  action="{{ route('module-add') }}" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label  class="col-lg-3 col-form-label" for="module_id">Module Id<span class="required">*</span></label>
                                    <div class="col-lg-6">
                                        <input id="module_id" type="text" class="form-control required" name="module_id" value="{{ old('modules_id') }}" placeholder="Modules Id" >
                                    </div>
                                </div>
                                <div class="form-group row">
